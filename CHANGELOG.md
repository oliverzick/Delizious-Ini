...
## [1.23.0] - 2026-04-20
### Added
- Enable merging an INI document with another INI document ([#210](https://github.com/oliverzick/Delizious-Ini/issues/210))

## [1.22.0] - 2026-03-29
### Changed
- Provide no comment line in an INI document at all when none comment is written for section or property ([#212](https://github.com/oliverzick/Delizious-Ini/issues/212))

## [1.21.0] - 2025-08-03
### Documented
- Improve documentation of configurability summary in README ([#208](https://github.com/oliverzick/Delizious-Ini/issues/208))
